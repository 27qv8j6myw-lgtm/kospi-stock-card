...
const devApiProxyRewrites = (): { source: string; destination: string }[] => {
  ...
  const paths = [
    ...
    'pro-portfolio-opus',
    'pro-diagnosis-archive',
    'pro-screener-archive',
    'pro-memory',
    'admin-pro-toggle',
    'admin-usage-cost-toggle',
    'admin-screener-toggle',
    'admin-ai-models',
    'admin-user-portfolio-counts',
    'admin-datasource-status',
    'admin-crowd-sentiment',
    'admin-crowd-portfolio',
    'admin-ops-briefing',
